...
**[Vet Clinic Project]** In this project I use a relational database to create the data structure for a vet clinic. I start with one table and step by step, finally create a complete database with data about:
...
If you like this project do not hesitate to give it a star...
